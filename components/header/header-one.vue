...
<!--                  <svg-shipping-car />-->
<!--                </span>-->
                <p>Ahora puedes comprar desde los Estados Unidos a tus familiares en Honduras. Contactanos por mensaje o llamada al +1 346-461-9433 para conocer más...</p>
              </div>
            </div>
            <div class="col-md-3">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-xl-2 col-lg-2 col-md-4 col-6">
              <div class="logo">
                <nuxt-link href="/">
                  <img src="/img/lainez/logolainez1.svg" alt="logo" />
                </nuxt-link>
              </div>
            </div>
